...
import com.mballem.curso.security.web.service.EspecialiadeService;
...
public class EspecialidadeController {
	...
	@Autowired
	private EspecialiadeService service;
	...
	public String excluir(@PathVariable("id") Long id, RedirectAttributes attr ) {
		service.remover(id);
		attr.addFlashAttribute("suceso", "Operação realizada com sucesso.");
		return "redirect:/especialidades";
	}
}
